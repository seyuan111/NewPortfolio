...
const Skills = () => {
  return (
    <div id="Skills" className="bg-slate-600 text-blue-300">
        <div className="max-w-[1000px] mx-auto p-6 py-[100px] flex flex-col justify-center w-full h-full">
            <div className="pb-8">
