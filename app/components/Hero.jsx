  ...
  return (
    <div className="w-full h-screen bg-slate-600">
      ...
      <div className="px-8 max-w-[1000px] mx-auto flex flex-col justify-center h-full">
        ...
        <div>
          <button><Link className="group text-white px-6 py-3 my-2 rounded-md bg-gray-400 flex items-center hover:bg-black duration-300" href="https://docs.google.com/document/d/1Fn0YlAT7r5QCfNNefyHRsO0xpyC1PYDCkxxhIImHUzY/edit">resume <span className="group-hover:rotate-90 duration-300"><FaArrowRight className="ml-2" size={20}/></span></Link></button></div>
        </div>
